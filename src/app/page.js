      ...
      <section className="py-10 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-lg text-gray-700 mb-6 text-left">
            El laboratorio virtual de hidrología (HYDROVLAB) es una iniciativa académica que tiene por finalidad proporcionar
          ...
          <p className="text-lg text-gray-700 mb-6 text-left">HYDROVLAB posee tres tipos de herramientas:</p>
          ...
          <p className="text-lg text-gray-700 mt-6 text-left">
            HYDROVLAB posee una interfaz amigable e interactiva, permite la colaboración e intercambio de información entre los usuarios mediante las tecnologías de la WEB 2.0, constituyéndose en un recurso didáctico invaluable en el estudio de la hidrología.
          </p>
