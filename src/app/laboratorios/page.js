...
export default function Simulaciones() {
    ...
    const simulaciones = [
        ...
        { id: 32, title: 'TransporteSedimentosTotal', description: 'Permite calcular el material que es arrastrado por la corriente en la capa de fondo que tiene un espesor igual al doble del diámetro de la partícula considerada.  Están disponibles los métodos de Duboys-Straub, Schoklits, Shields, Meyer-Peter y Muller, Leví, Einstein, Einstein-Brown, Sato-Kikkawa-Ashida, Rottner, Frijlink, Yalin, Pernecker-Vollmer,Inlis-Lacey, Bogardi y Van Rijn.', link: '/Experimentos/TransporteSedimentosTotal', category: 'Transporte de sedimentos' },
