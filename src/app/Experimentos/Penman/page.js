...
//       </div>
//       <div>
//         <label>Humedad Relativa (h): </label>
//         <input type="number" step="any" value={h} onChange={e => setH(e.target.value)} />
//       </div>
//       <div>
//         <label>n/D: </label>
//         <input type="number" step="any" value={nd} onChange={e => setND(e.target.value)} />
//       </div>
//       <div>
//         <label>Vel. viento (m/s): </label>
//         <input type="number" step="any" value={u2} onChange={e => setU2(e.target.value)} />
//       </div>
//       <div>
//         <label>Energía Ra (cal/cm²/día): </label>
//         <input type="number" step="any" value={Ra} onChange={e => setRa(e.target.value)} />
//       </div>
//       <div>
//         <label>Albedo superficie (r): </label>
//         <input type="number" step="any" value={r} onChange={e => setR(e.target.value)} />
//       </div>
...
//         <div>
//           <h3>Resultados:</h3>
//           <p>e (mmHg): {resultados.e}</p>
//           <p>ea (mmHg): {resultados.ea}</p>
//           <p>Ta (K): {resultados.Ta}</p>
//           <p>∆ (mm de Hg/°C): {resultados.D}</p>
//           <p>Rc (cal/cm²/día): {resultados.Rc}</p>
//           <p>RI (cal/cm²/día): {resultados.RI}</p>
//           <p>RB (cal/cm²/día): {resultados.RB}</p>
//           <p>H (cal/cm²/día): {resultados.H2}</p>
//           <p>Ea (cal/cm²/día): {resultados.Ea2}</p>
//           <p>E'o (cal/cm²/día): {resultados.EoCal}</p>
//           <p>E'o (mm/día): {resultados.EoMm}</p>
//         </div>
//       )}
//     </div>
//   );
